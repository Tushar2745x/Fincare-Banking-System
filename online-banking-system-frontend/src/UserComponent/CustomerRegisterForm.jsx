...
const CustomerRegisterForm = () => {
  ...
  const saveUser = (e) => {
    ...
    const aadhaarDigits = String(user.aadhaarCard || "").replace(/\D/g, "");
    ...
    const jwtToken = sessionStorage.getItem("bank-jwtToken");
      ...
      .then((result) => {
        result.json().then((res) => {
          if (res.success) {
            ...
            setTimeout(() => navigate("/bank/customer/all"), 1000);
          } else {
    ...
    >
      ...
      <div className="register-card">
        <div className="register-header">
          <h5 className="mb-0">Customer Registration</h5>
        </div>
